                        ...
                        @foreach($conversations as $conv)
                            @if(in_array($conv->user_id,$array)==false)
                                ...
                                <div
                                    ...
                                    onclick="viewConvs('{{route('admin.message.view',[$conv->user_id])}}','customer-{{$conv->user_id}}', '{{$conv->user_id}}' , '{{$conv->user_id}}')"
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
    <script>
     var url_2;
        ...
        function viewConvs(url,id_to_active, user_id_1) {

            url_2 = "{{ URL('admin/message/view-refresh/') }}" +"/" + user_id_1;
