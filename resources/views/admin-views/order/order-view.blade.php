                    ...
                    <div class="card-header" style="display: block!important;">
                        <div class="row">
                            ...
                            <div class="col-12 pb-2 border-bottom">
                               ...
                               <!-- <button onclick="window.location='{{route('admin.orders.product-list', [$order['id']])}}'" type="button" class="btn btn-info" data-toggle="modal">Add porduct</button> 
                               <button onclick="window.location='{{route('admin.orders.generate-invoice', [$order['id']])}}'" type="button" class="btn btn-info" data-toggle="modal">Generate Invoices</button>  -->
                            </div>  
                            <hr>
                        ...
                        <a style="padding-right:3px;" href={{route('admin.orders.view-invoice',[$invoice['branch_id'], $order['id']])}}>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{route('admin.orders.update-order-details',[$detail['id']])}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{route('admin.orders.delete-item',[$detail['id']])}}" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                  <div class="hs-unfold ml-1">
