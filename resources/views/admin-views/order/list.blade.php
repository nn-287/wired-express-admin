                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="{{route('admin.orders.details',['id'=>$order['id']])}}"><i class="tio-visible"></i> {{trans('messages.view')}}</a>
                                    <!-- <a class="dropdown-item" target="_blank" href="{{route('admin.orders.generate-invoice',[$order['id']])}}"><i class="tio-download"></i> {{trans('messages.invoice')}}</a> -->

                                    <!-- <a class="dropdown-item" href="javascript:" onclick="form_alert('order-{{$order['id']}}','Want to delete this item')">{{trans('messages.delete')}}</a> -->
                                    <form action="{{route('admin.orders.delete-order',[$order['id']])}}" method="post" id="order-{{$order['id']}}">
                                        @csrf @method('delete')
                                    </form>
                                </div>
                            </div>
