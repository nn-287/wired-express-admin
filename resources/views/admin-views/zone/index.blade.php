                            ...
                            <div class="pl-xl-5 pl-xxl-0">
                                ...
                                <div class="tab-content">
                                    <div class="form-group mb-3 lang_form" id="default-form">
                                        ...
                                        <input type="text" name="name"  class="form-control" placeholder="Type zone name here"
                                    ...
                                    <div class="form-group mb-3 lang_form" id="default-form">
                                        ...
                                        <input type="number" name="delivery_fee"  class="form-control" placeholder="Type delivery fee here"
                                         maxlength="191" id="default-form-input"  oninvalid="document.getElementById('default-form-input').click()" requied>
                                    </div>
                                </div>
...
<script>
    ...
    <script>
        ...
        function initialize() {
            @php($default_location=\App\Model\BusinessSetting::where('key','default_location')->first())
