        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="product_form"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select name="brand_id" class="form-control js-select2-custom" >
                                    @foreach(\App\Model\Brand::orderBy('name')->get() as $brand)
                    ...
                    <!-- <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">Order <span style="color:#36adb4">(hint: If order = 2 and setmenu of this product is true it will appear on all devices in the Set Menu)</span></label>
